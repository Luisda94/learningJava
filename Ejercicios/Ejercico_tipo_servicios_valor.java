...
public class Ejercico_tipo_servicios_valor {
	...
	public static void main(String[] args) {
		 ...
		 * Por cada servicio que preste se tienen los siguientes datos:
...
*  Al final del día se requiere
* determinar el valor producido por cada clase de servicio, 
* el número de veces que se prestó cada servicio, 
* el servicio que más se prestó y si éste se prestó más en la mañana o en la tarde.
